FROM registry.access.redhat.com/ubi9/php-83:latest AS projectsend-source
...
# -- Build node modules
FROM registry.access.redhat.com/ubi9/nodejs-24-minimal:latest AS nodejs-build
...
FROM registry.access.redhat.com/ubi9/php-83:latest AS php-prepare
...
# -- Build gulp modules
FROM registry.access.redhat.com/ubi9/nodejs-24-minimal:latest AS gulp-build
...
FROM registry.access.redhat.com/ubi9/php-83:latest AS php-assemble
